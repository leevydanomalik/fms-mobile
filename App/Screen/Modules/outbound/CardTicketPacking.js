...
class CardTicketPacking extends React.Component {
    static defaultProps = {
        onPress: () => null
    }
    ...
    render() {
        ...
        let pickers = datas ? datas.pic && datas.pic.userName ? datas.pic.userName.toUpperCase() : "" : ""
        ...
        return (
            <View style={{ paddingTop: id == 0 ? 5 : 15, padding: 15, paddingBottom: 0 }}>
                {!collapse ? (
                    <TouchableOpacity onPress={onPress} style={{ ...styles.container, borderWidth: objectID === data.item.humanTaskID ? 3 : 0, borderColor: objectID === data.item.humanTaskID ? Colors.mainPlaceholder : "transparent" }}>
                    ...
                    <TouchableOpacity onPress={onPress} style={{ ...styles.container, borderWidth: objectID === data.item.humanTaskID ? 3 : 0, borderColor: objectID === data.item.humanTaskID ? Colors.mainPlaceholder : "transparent" }}>
                        ...
                        <View style={{ marginTop: 20, flexDirection: "row", alignItems: "center", alignContent: "center", justifyContent: "space-between" }}>
                            <Text style={{ color: "#000", fontSize: 18, fontWeight: "bold" }}>{`Packing ${poPocID}`}</Text>
...
export default CardTicketPacking