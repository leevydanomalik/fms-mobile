    ...
    render () {
        ...
        return (
            <View style={{ marginTop: 1, backgroundColor: "#fff" }}>
                ...
                <View style={{ padding: 20, flex: 0, flexDirection: 'row', justifyContent: 'space-between', paddingBottom: 20, paddingTop: 20, backgroundColor: "#fff", borderTopWidth: 0.5, borderTopColor: '#ccc', borderBottomWidth: 0.5, borderBottomColor: '#ccc' }}>
                    <View style={{ flex: 1 }}>
                        <Text style={{ fontSize: 12, color: "#999" }}>UOM</Text>
                        <Text style={{ color: "#000", fontSize: 20, fontWeight: "bold" }}>BOX</Text>
                    </View>
                    <View style={{ flex: 1, alignItems: 'center' }}>
                        <Text style={{ fontSize: 12, color: "#999" }}>PALLET</Text>
...
class GIInfo extends Component {
    constructor(props) {
        super(props)
        this.state = {
            ...
            <View>
                <View style={{ marginTop: 0, backgroundColor: "#fff", padding: 20, paddingBottom: 0, borderTopWidth: 10, borderTopColor: '#f0f0f0' }}>
                    <View style={{ flex: 0, flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 0 }}>
                        <Text style={{ fontSize: 16, fontWeight: "bold", color: "#999" }}>Good Issue Information</Text>
                    </View>
                </View>

                <CardMaterial onEnlarge={() => this.setState({visibleBottomPopup: true, isMaterialDetail: true})} />
                <CardMaterial onEnlarge={() => this.setState({visibleBottomPopup: true, isMaterialDetail: true})} />
                <CardMaterial onEnlarge={() => this.setState({visibleBottomPopup: true, isMaterialDetail: true})} />
