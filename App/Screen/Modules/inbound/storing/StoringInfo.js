...
class StoringInfo extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    render() {
        ...
        return (
            <View>
                <View style={{ marginTop: 10, backgroundColor: "#fff", padding: 20, borderBottomWidth: 1, borderBottomColor: '#f0f0f0' }}>
                    <View style={{ flex: 0, flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 15 }}>
                        <Text style={{ fontSize: 16, fontWeight: "bold", color: "#999" }}>Storing Information</Text>
                    </View>
                ...
                <View style={{ flex: 0, flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10, marginTop: 10, backgroundColor: "#fff", padding: 20 }}>
                    <View style={{ flex: 0 }}>
