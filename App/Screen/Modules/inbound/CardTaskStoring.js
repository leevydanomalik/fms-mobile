        ...
        document.material && document.material.map((dt) => {
            ...
            dummyMaterials.push({
                ...
                warehouse: [
                    ...
                    {
                        ...warehouse[1],
                        id: dt.to_bq ? dt.to_bq : '-',
                        subtitle: dt.to_bq_lc ? dt.to_bq_lc : '-',
                        description: dt.to_bq ? dt.to_bq : '-'
                    }
                ],
                detail: {...dt},
                document: {...document},
