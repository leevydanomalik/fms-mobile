...
class CardTicketStoring extends Component {
    constructor(props) {
        super(props)
        this.state = {
            visible: false,
                    ...
                    {!collapse ? (
                        ...
                        <View>
                            ...
                            <View style={{ marginTop: 20, flexDirection: "row", alignItems: "center", alignContent: "center", justifyContent: "space-between" }}>
                                <Text style={{ color: "#000", fontSize: 18, fontWeight: "bold" }}>{`Storing ${poNumber}`}</Text>
...
export default connect(mapStateToProps, null)(CardTicketStoring)