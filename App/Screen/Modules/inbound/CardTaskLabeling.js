...
class CardTaskLabeling extends Component {
    constructor(props) {
        super(props)
        const { rowData } = props
    ...
    render() {
        ...
        document.material && document.material.map((dt) => {
            ...
            dummyMaterials.push({
                ...
                isOutbound: doc_info.source === 'INBOUND DELIVERY' ? false : true,
                kimap: dt.kimap,
                hu_no: dt.hu_no,
                hu_cap: dt.hu_cap,
                name: dt.name, 
