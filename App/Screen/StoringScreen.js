...
class StoringScreen extends Component {
    constructor(props) {
        super(props)
    ...
    getDataTaskList = async (limit, offset, tabs) => {
        ...
        let payload = {
            ...
            offset: offset,
            params: {
                humanTaskType: "INBOUND_DELIVERY_STORING",
        ...
        let res = ""
        let response = await Api.create().getCountHumanTaskListByType("INBOUND_DELIVERY_STORING")
...
export default connect(mapStateToProps, null)(StoringScreen)