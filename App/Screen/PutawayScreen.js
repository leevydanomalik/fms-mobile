...
// import CardTicketPutaway from "./Modules/inbound/CardTicketPutaway"
...
class PutawayScreen extends Component {
    constructor(props) {
        super(props)
    ...
    getDataTaskList = async (limit, offset) => {
        ...
        let payload = {
            ...
            offset: offset,
            params: {
                humanTaskType: "INBOUND_DELIVERY_PUTAWAY",
                assignment: user.data.userID,
                status: ""
            }
        }
        let response = await Api.create().getCountHumanTaskListByType("INBOUND_DELIVERY_PUTAWAY")
