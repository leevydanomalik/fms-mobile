...
class PickingScreen extends Component {
    constructor(props) {
        super(props)
    ...
    getDataTaskList = async (limit, offset, tabs) => {
        ...
        let payload = {
            ...
            offset: offset,
            params: {
                humanTaskType: "OUTBOUND_DELIVERY_PICKING",
        ...
        let res = ""
        let response = await Api.create().getCountHumanTaskListByType("OUTBOUND_DELIVERY_PICKING")
        ...
        if (res.data && res.data.status === "S") {
            ...
            data && data.map((dt) => {
                ...
                console.log('pyl', pyl.ticket_info)
                rawData.push({
                    ...pyl,
...
export default connect(mapStateToProps, null)(PickingScreen)