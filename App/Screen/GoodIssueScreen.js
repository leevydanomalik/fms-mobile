...
class GoodReceiptScreen extends Component {
    ...
    componentDidMount() {
        ...
        messaging().onMessage(async remoteMessage => {
            ...
            if (remoteMessage.data.title == "YND Information GI") {
                ...
                console.log("ex", isExist, this.state.rawData)
                if (isExist >= 0) {
    ...
    getDataTaskList = async (limit, offset, tabs) => {
        ...
        let payload = {
            ...
            offset: offset,
            params: {
                humanTaskType: "OUTBOUND_DELIVERY_GI",
        ...
        let res = ""
        let response = await Api.create().getCountHumanTaskListByType("OUTBOUND_DELIVERY_GI")
